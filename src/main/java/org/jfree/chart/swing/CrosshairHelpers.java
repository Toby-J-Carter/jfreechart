...
public class CrosshairHelpers {
     ...
     */
    protected static void drawHorizontalCrosshair(Graphics2D g2, Rectangle2D dataArea,
     ...
     * @param crosshair  the crosshair.
     */
    protected static void drawVerticalCrosshair(Graphics2D g2, Rectangle2D dataArea,
     ...
     */
    private static Point2D calculateLabelPoint(Line2D line, RectangleAnchor anchor,
    ...
    private static RectangleAnchor flipAnchorH(RectangleAnchor anchor) {
    ...
    private static RectangleAnchor flipAnchorV(RectangleAnchor anchor) {
        RectangleAnchor result = anchor;
        if (anchor.equals(RectangleAnchor.TOP_LEFT)) {
            result = RectangleAnchor.BOTTOM_LEFT;
        }
